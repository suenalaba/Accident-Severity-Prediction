# ===============================================================================================================
# Purpose:      Cleaning Dataset for Tableau Visualisation
# Author:       Joshua Khoo, Joel Mui, Ethan ong, Brandon Quek, He Ying
# DOC:          02-04-2022
# Topics:       Data Cleaning
# Data Source:  dft-road-casualty-statistics-accident-last-5-years.csv, dft-road-casualty-statistics-vehicle-last-5-years.csv,
                #dft-road-casualty-statistics-accident-last-5-years.csv, Local_Authority_District_to_County_(December_2017)_Lookup_in_England_(UPDATED).csv
# Packages:     data.table, stringr
#================================================================================================================
...
#Merging local authority district codes with actual local authority district names

#===============================================================================

accidents <- copy(accidents_combined.dt)

#import location name to join on
