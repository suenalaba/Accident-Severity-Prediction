# ===============================================================================================================
# Purpose:      Cleaning and Visualization for Vehicle Data
...
vehicle_type[vehicle.dt$vehicle_type == 2|vehicle.dt$vehicle_type == 3|
               ...
               vehicle.dt$vehicle_type == 23 | vehicle.dt$vehicle_type == 97] <- "Motorcycle"
...
#vehicle_direction to or from doesn't provide much value while age of driver has already been grouped
#so we will remove them
colsToRemove = c("vehicle_direction_to", "vehicle_direction_from", "age_of_driver","accident_year")

vehicle.dt[,(colsToRemove):=NULL]
