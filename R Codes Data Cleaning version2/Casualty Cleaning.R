...
#set of attributes to be used for machine learning.
casualtyml.dt <- casualty.dt[,c("casualty_agegroup","pedestrian_movement","casualty_type",
                                "casualty_class","casualty_sex","pedestrian_location")]
